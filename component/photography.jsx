import Photo1 from '../src/assets/wedding beach.jpg';

function Photography(){
	return(
		<div id="photoandvideo" className="w-full h-auto overflow-auto">
		  ...
		  <div id="photoBox" className="flex flex-col w-full items-center md:flex-row">
		    <div id="samplephoto" className="h-96 w-full md:w-1/3">
		      <img src={Photo1} className="skeleton w-full h-full object-contain" alt="Photography 1"/>
		    </div>
